...
class User(Base):
    ...
    # used to make Quolvex AI mirror their tone/formality/energy in replies.
...
class UserSettings(Base):
    ...
    system_prompt = Column(Text, default="You are Quolvex AI, created by Wanzu Ibrahim. Answer accurately and helpfully.")
...
class UsedDevice(Base):
    """Fingerprinted devices that have already joined Quolvex AI (invite anti-farming)."""
