        ...
        filtered.forEach(u => {
            ...
            div.innerHTML = `
                ...
                <div style="flex:1; overflow:hidden;">
                    <div style="font-size:13px; font-weight:600; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${AdminPanel.escapeHtml(u.username)} ${u.is_admin?'<span style=\'color:#FFD700; font-size:10px;\'>ADMIN</span>':''}</div>
