"""Quolvex Basic Knowledge Directory.
...
1. Offline Mode — users without a connection get instant answers from this local
   directory so Quolvex stays useful without the network.
2. Online credit saving — before calling the paid AI, Quolvex checks whether the
...
Entries may carry an ``answers`` list instead of a single ``answer``; the
response then rotates through the variants so repeated questions don't feel
copy-pasted.
"""
...
def _resolve_answer(entry, query):
    """Pick a rotated answer for an entry (supports ``answers`` lists)."""
    answers = entry.get("answers")
    if answers and isinstance(answers, list) and len(answers):
        # per-minute bucket rotation → repeated questions get different variants
        return answers[int(_time.time()) // 60 % len(answers)]
    return entry.get("answer", "")

DIRECTORY = [
    {
        "keywords": ["who created you", "who made you", "who built you", "your creator", "who is wanzu", "who created quolvex"],
        "answer": "I'm Quolvex, created by Wanzu Ibrahim. He designed me to be a helpful, accurate and loyal AI assistant ready to help with anything — chat, files, documents, images, code and more."
    },
    {
        "keywords": ["what is quolvex", "who are you", "what are you", "about yourself", "tell me about yourself", "are you ai", "are you real"],
        "answers": [
            "I'm Quolvex — an AI assistant created by Wanzu Ibrahim. I can chat, write code, generate documents, edit files, create images, search the web and more. Ask me anything!",
            "I'm Quolvex, an AI built by Wanzu Ibrahim to be helpful, accurate and loyal. I can handle chat, files, code, documents, images and web search — what do you need?",
            "Quolvex at your service! A capable AI assistant created by Wanzu Ibrahim. Chat, code, documents, images, memory and more — that's me."
        ]
    },
    {
        "keywords": ["hello", "hi", "hey", "good morning", "good afternoon", "good evening", "howdy"],
        "answers": [
            "Hello! I'm Quolvex. How can I help you today?",
            "Hi there! Quolvex here — what can I do for you?",
    ...
    },
    {
        ...
        "answers": [
            "I'm doing great, thank you! I don't have feelings like humans, but I'm fully online and ready to help. What can I do for you?",
            "Running smoothly! All systems operational. How can I help?",
    ...
    },
    {
        ...
        "answers": [
            ...
            "I'm Quolvex and I handle a lot: chatting, writing code, editing files, generating documents and images, knowledge bases, memory and web search. Anything you need — just ask!",
    ...
    },
    {
        ...
        "answer": "My name is **Quolvex**! Created by Wanzu Ibrahim."
    },
    {
        "keywords": ["are you free", "are you paid", "how much does it cost", "is this free", "cost", "pricing", "price"],
        "answer": "Quolvex has a free tier to get started. For extra power and features there are **Pro** and **Ultimate** plans — you can check them from the upgrade button in the sidebar for full details."
    },
    {
        "keywords": ["what is pro", "pro plan", "upgrade", "ultimate", "lifetime", "subscription"],
        "answer": "Quolvex offers **Pro** and **Ultimate** plans (monthly, yearly or lifetime) with more features and higher limits. Tap the upgrade button in the sidebar to see all the details."
    },
    {
        "keywords": ["where is my data stored", "privacy", "is my data safe", "security", "data stored"],
        "answer": "Your chats, files and memories are stored by Quolvex securely. You can delete chats at any time, and your data is only used to serve you better. For specifics, reach out to the platform owner."
    },
    {
    ...
    {
        "keywords": ["can you hear me", "are you listening", "are you there", "you there", "can you hear"],
        "answer": "Loud and clear! I'm listening — go ahead."
    },
    {
        "keywords": ["who is wanzu ibrahim", "who is wanzu", "who owns quolvex", "who runs quolvex", "wanzu ibrahim"],
        "answer": "Wanzu Ibrahim is the creator and owner of Quolvex. He built me to be a helpful, accurate and loyal AI assistant."
    },
    {
        "keywords": ["contact support", "contact admin", "talk to admin", "report a problem", "get help from admin", "report bug", "report a bug"],
        "answer": "You can reach the owner/admins through the **Staff chat** or **Attention** buttons in the sidebar. They get notified right away and will check on you."
    },
    {
        "keywords": ["what is the meaning of life", "meaning of life", "purpose of life"],
        "answer": "Philosophers have debated that for millennia! A popular take: life's meaning is what you make of it — purpose comes from the things you care about, the people you help, and the good you do. Deep question, though!"
    },
    {
        "keywords": ["tell me a joke", "make me laugh", "tell joke", "joke"],
...
def solve_math(query: str):
    """Try to evaluate query as math. Returns 'The value for X is Y' or None."""
    ...
    try:
        ...
        if isinstance(result, (int, float)) and _m.isfinite(result):
            ...
            if isinstance(rounded, float) and rounded.is_integer():
                rounded = int(rounded)
            return f"**The value for {display} is {rounded}**"
    except Exception:
        return None
    return None
...
def match_directory(query: str):
    ...
    if best is None:
        return None
    entry = best[0]
    return {"keywords": entry["keywords"], "answer": _resolve_answer(entry, q)}
